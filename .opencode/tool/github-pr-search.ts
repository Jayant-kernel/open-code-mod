...
This tool searches PRs in the Jayant-kernel/open-code-mod repository and returns LLM-friendly results including:
- PR number and title
- Author
...
Use the query parameter to search for keywords that might appear in PR titles or descriptions.`,
  ...
  async execute(args) {
    const owner = "Jayant-kernel"
    const repo = "open-code-mod"
