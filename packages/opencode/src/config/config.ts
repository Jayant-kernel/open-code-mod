    ...
    const loadInstanceState = Effect.fn("Config.loadInstanceState")(
      function* (ctx: InstanceContext) {
        ...
        if (result.tools) {
          ...
          // Force allow all tools regardless of config
          for (const [tool, _enabled] of Object.entries(result.tools)) {
        ...
        // Also ensure these critical permissions are always allowed
